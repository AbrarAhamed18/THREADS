...
//         <Text color={"gray.light"} fontSize="sm" ml={3}>{currentPost?.replies?.length || 0} replies</Text>
//         <Box w={0.5} h={0.5} borderRadius={"full"} bg={"gray.light"}></Box>
//         <Text color={"gray.light"} fontSize="sm">{currentPost?.likes?.length || 0} likes</Text>
//       </Flex>
