...
const followUnFollowUser = async(req,res)=>{
    try {
        ...
        if(isFollowing){
            //unfollow user
            // modify current user following array , modify followers of usertomodify
...
const updateUser = async(req,res)=>{
    ...
    try {
        ...
        //find all posts that this user replies and update username and userProfilePic field
